...
export const Route = createFileRoute("/courses")({
  ...
  head: () => ({
    meta: [
      { title: "Courses — Qumra Academy" },
      { name: "description", content: "Explore all Qumra Academy courses: Quran, Islamic Studies, Arabic Language, and Kids." },
      { property: "og:title", content: "Courses — Qumra Academy" },
